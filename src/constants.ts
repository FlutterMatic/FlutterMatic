...
export const gitCloneCommand = `git clone --depth 1 --branch beta https://github.com/flutter/flutter.git "${join(
  homedir(),
  '.flutter-sdktest'
)}"`;
...
export const configEnableWebFlutter = `${join(
  homedir(),
  '.flutter-sdktest',
  'bin',
  'flutter'
...
export const openVsCode =
  'Please open VSCode in the directory to start coding. We could not open vscode for you as you do not have it on path!';
...
export const createInstallDir =
  'All dependencies present. Proceeding to create installation directory';
export const startWebApp = 'Starting webapp creation';
export const pickOneFolder = 'You need to pick one folder to continue or be in a workspace';
export const dartPackageFormat =
  'The project name should not include spaces and numbers. It should conform to the Dart Package guidelines';
export const projectNameEmpty = 'Project name can not be empty!';
